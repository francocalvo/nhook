...
class CronogramaSyncWorkflow(BaseWorkflow):
    ...
    def matches(self, context: WorkflowContext) -> bool:
        ...
        """
        return "Date" in context.payload
    ...
    async def execute(self, context: WorkflowContext) -> dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Found {len(cronograma_ids)} Cronograma entries to link")
            ...
            logger.error(f"Failed to sync Cronograma for {page_id}: {e}")
